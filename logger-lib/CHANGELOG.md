...
- PIO tests depend on HC-LIB.System for _unity_extensions.h_ (included after _Log.h_ so native _F()_ stays the Logger overload). Nano test builds shrink Serial buffers and drop Unity float/details to stay under 2 KB SRAM.
